...
train_file=${CDIR}/data/fasttext.train
test_file=${CDIR}/data/fasttext.test
model_file=${CDIR}/data/fasttext

${python} ${CDIR}/train_classifier.py --train=${train_file} --model=${model_file}
${python} ${CDIR}/evaluate_classifier.py --model=${model_file}.bin --test=${test_file}
